...
describe('Laundromat instance - `laundromat`', function(){
  ...
  context('push() method - `laundromat.push()`', function(){
    ...
    it('should exist');
    it('should take a washing machine function and return itself');
...
describe('Laundromat middleware - `laundromat()`', function(){
  ...
  it('should loop back to the first washing machine function when one performs a change - aka `next` callback receives a modification object');
